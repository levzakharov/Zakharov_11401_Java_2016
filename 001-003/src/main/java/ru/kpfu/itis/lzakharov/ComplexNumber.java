...
public class ComplexNumber {
    ...
    public ComplexNumber add(ComplexNumber x) {
        ...
        res.setRe(this.getRe() + x.getRe());
        res.setIm(this.getIm() + x.getIm());
    ...
    public ComplexNumber mult(ComplexNumber x) {
        ComplexNumber res = new ComplexNumber();
        res.setRe(this.getRe() * x.getRe() - this.getIm() * x.getIm());
        res.setIm(this.getRe() * x.getIm() + this.getIm() * x.getRe());
